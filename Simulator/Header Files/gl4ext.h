...
public:
	//OpenGLScreenQuad(const char* psfile = "../GLSL/SHADER/screenquad.frag", const char* defines = nullptr);
	OpenGLScreenQuad(const char* psfile, const char* vsfile, const char* defines = nullptr);
	~OpenGLScreenQuad();
